...
export const metadata = {
  title: 'Step by Step Guide to Heal Emotional Wounds - EmotionEase',
  description: 'A comprehensive guide to understanding and healing emotional wounds',
  keywords: 'emotional healing, trauma recovery, emotional wounds, healing guide',
  openGraph: {
    title: 'Step by Step Guide to Heal Emotional Wounds',
    description: 'Practical steps for emotional healing and recovery',
    type: 'article',
    images: ['/assets/Healing your Emotional Wounds.webp'],
  },
}
...
export default function BlogPost2() {
  return (
    <>
      <Navbar />
      <main>
        {/* Copy content from temp-pages/Blog2.jsx */}
