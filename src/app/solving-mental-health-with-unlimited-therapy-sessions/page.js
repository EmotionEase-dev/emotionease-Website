...
export const metadata = {
  title: 'Solving Mental Health with Unlimited Therapy Sessions - EmotionEase',
  description: 'Learn how unlimited therapy sessions can help improve mental health outcomes',
  keywords: 'unlimited therapy, mental health solutions, therapy sessions',
  openGraph: {
    title: 'Solving Mental Health with Unlimited Therapy Sessions',
    description: 'Comprehensive guide to unlimited therapy benefits',
    type: 'article',
  },
}
...
export default function BlogPost1() {
  return (
    <>
      <Navbar />
      <main>
        {/* Copy content from temp-pages/Blog1.jsx */}
