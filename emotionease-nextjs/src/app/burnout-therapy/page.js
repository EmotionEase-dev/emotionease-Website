...
import './BurnoutTherapy.css'

export default function BurnoutTherapyPage() {
  useEffect(() => {
    // Scroll animations
  ...
  return (
    <>
              ...
              <Col lg={6} className="animate-on-scroll fade-in-up">
                <div className="section-header mb-4 d-flex align-items-start">
                  <div className="icon-wrapper bg-success-subtle text-success rounded-circle p-3 me-3 flex-shrink-0">
                    <i className="bi bi-heartbreak fs-4"></i>
                  </div>
                  <h1 className="fw-bold mb-0" style={{fontSize: '1.75rem', lineHeight: '1.3'}}>What is Burnout?</h1>
                </div>
            ...
            <Row className="g-5">
              <Col lg={12} className="animate-on-scroll fade-in-up">
                <div className="section-header mb-4 d-flex align-items-start">
                  ...
                  <h2 className="fw-bold mb-0" style={{fontSize: '1.5rem', lineHeight: '1.3'}}>What is Burnout Therapy?</h2>
                </div>

                <Row className="justify-content-center mt-4">
                  <Col lg={10}>
                    <p className="text-center" style={{fontSize: '1rem', lineHeight: '1.7'}}>
            ...
            <Row className="g-5">
              <Col lg={12} className="animate-on-scroll fade-in-up">
                <div className="section-header mb-4 d-flex align-items-start">
                  ...
                  <h3 className="fw-bold mb-0" style={{fontSize: '1.5rem', lineHeight: '1.3'}}>Common Signs and Symptoms of Burnout</h3>
                </div>
                
                <p className="mb-4" style={{fontSize: '1rem', lineHeight: '1.7'}}>
                    ...
                    <Col md={6} key={index}>
                      <Card className="h-100 border-0 shadow-sm hover-lift">
                        <Card.Body className="d-flex align-items-start p-3">
                          <i className="bi bi-check-circle-fill text-success fs-5 me-3 mt-1"></i>
                          <p className="mb-0" style={{fontSize: '0.95rem'}}>{symptom}</p>
                        </Card.Body>
                      </Card>
                    </Col>
                  ))}
        ...
        <Container>
          <div className="animate-on-scroll fade-in-up text-center mb-5">
            ...
            <p className="text-muted">
              Here are some of the most common questions people ask about burnout therapy and recovery.
            </p>
          </div>
            ...
            <Col lg={10}>
              <Accordion defaultActiveKey="0" flush>
                <Accordion.Item eventKey="0" className="mb-3 shadow-sm rounded-3 border-0 overflow-hidden">
                  <Accordion.Header>Who can enroll for burnout therapy?</Accordion.Header>
                  <Accordion.Body>
                ...
                <Accordion.Item eventKey="1" className="mb-3 shadow-sm rounded-3 border-0 overflow-hidden">
                  <Accordion.Header>How will burnout therapy help?</Accordion.Header>
                  <Accordion.Body>
                ...
                <Accordion.Item eventKey="2" className="mb-3 shadow-sm rounded-3 border-0 overflow-hidden">
                  <Accordion.Header>Is burnout common among individuals?</Accordion.Header>
                  <Accordion.Body>
                ...
                <Accordion.Item eventKey="4" className="mb-3 shadow-sm rounded-3 border-0 overflow-hidden">
                  <Accordion.Header>Who can enroll for the burnout therapy session worldwide?</Accordion.Header>
                  <Accordion.Body>
                ...
                <Accordion.Item eventKey="5" className="mb-3 shadow-sm rounded-3 border-0 overflow-hidden">
                  <Accordion.Header>How long does each burnout therapy session with EmotionEase last?</Accordion.Header>
                  <Accordion.Body>
      ...
      <section className="py-5 bg-success text-light text-center">
        <Container>
          <h2 className="display-5 fw-bold mb-4">Ready to Overcome Burnout?</h2>
          <p className="lead mb-5 mx-auto" style={{ maxWidth: '600px' }}>
            Let EmotionEase guide you back to balance, energy, and purpose.
          </p>
          <Link 
            href="/contact"
