export default function PrivacyPolicy() {
  return (
    <div className="container py-5" style={{ maxWidth: '900px' }}>
      <div className="mb-4">
        <h1 className="text-success mb-2">Terms and Conditions</h1>
        <p className="text-muted">Last Updated: 14/05/2025</p>
      </div>
      ...
      <div className="content">
        ...
        <section className="mb-4">
          <h5 className="fw-bold text-success mb-3">1. Service Description</h5>
          <p>
        ...
        <section className="mb-4">
          <h5 className="fw-bold text-success mb-3">2. Important Disclaimers</h5>
        ...
        <section className="mb-4">
          <h5 className="fw-bold text-success mb-3">3. User Responsibilities</h5>
          <p>
        ...
        {/* 4. Session Policies */}
        <section className="mb-4">
          <h5 className="fw-bold text-success mb-3">4. Session Policies</h5>
          
          <h6 className="fw-bold mt-3 mb-2">Eligibility:</h6>
          <ul className="mb-3">
            <li>Participants must be between 25-50 years old</li>
            <li>Valid government ID may be required for verification</li>
          </ul>

          <h6 className="fw-bold mt-3 mb-2">Booking and Cancellation:</h6>
          <ul className="mb-3">
          ...
          <h6 className="fw-bold mt-3 mb-2">Refund Policy:</h6>
          <ul className="mb-3">
        ...
        <section className="mb-4">
          <h5 className="fw-bold text-success mb-3">5. Privacy and Confidentiality</h5>
          <p>
        ...
        <section className="mb-4">
          <h5 className="fw-bold text-success mb-3">6. Intellectual Property</h5>
          <p>
        ...
        <section className="mb-4">
          <h5 className="fw-bold text-success mb-3">7. Limitation of Liability</h5>
          <p>
        ...
        {/* 8. Changes to Terms */}
        <section className="mb-4">
          <h5 className="fw-bold text-success mb-3">8. Changes to Terms</h5>
          <p>
        ...
        {/* 9. Governing Law */}
        <section className="mb-4">
          <h5 className="fw-bold text-success mb-3">9. Governing Law</h5>
          <p>
        ...
        <section className="mb-4">
          <h5 className="fw-bold text-success mb-3">10. Contact Us</h5>
          <p>
