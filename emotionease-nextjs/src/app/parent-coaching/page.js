    ...
    <>
      ...
      <div className="parent-coaching-page container py-5 py-lg-5" style={{ marginTop: '10px' }}>
            ...
            <Row className="g-5 align-items-center">
              ...
              <Col lg={6} className="animate-on-scroll fade-in-up">
                <div className="section-header mb-4 d-flex align-items-start">
                  ...
                  <h1 className="fw-bold mb-0" style={{fontSize: '1.75rem', lineHeight: '1.3'}}>What is Parent Coaching and Why Do You Need It?</h1>
                </div>
            ...
            <Row className="g-5 align-items-center flex-lg-row-reverse">
              ...
              <Col lg={6} className="animate-on-scroll fade-in-up">
                <div className="section-header mb-4 d-flex align-items-start">
                  ...
                  <h2 className="fw-bold mb-0" style={{fontSize: '1.5rem', lineHeight: '1.3'}}>Confidence Building and Fearlessness Training for Kids</h2>
                </div>
            ...
            <Row className="g-5">
              <Col lg={12} className="animate-on-scroll fade-in-up">
                <div className="section-header mb-4 d-flex align-items-start">
                  ...
                  <h3 className="fw-bold mb-0" style={{fontSize: '1.5rem', lineHeight: '1.3'}}>Common Causes of Low Confidence in Children</h3>
                </div>

                <p className="text-muted mb-4">There are many reasons why a child may appear overly shy, anxious, or lacking in confidence.</p>

                <Row className="g-4 mt-2">
                  {[
                    {
                      title: "Bullying experiences",
                      icon: "bi-heart-pulse"
                    },
                    {
                      title: "Lack of emotional validation",
                      icon: "bi-heart-pulse"
                    },
                    {
                      title: "Excessive time spent alone",
                      icon: "bi-heart-pulse"
                    },
                    {
                      title: "Constant criticism",
                      icon: "bi-heart-pulse"
                    },
                    {
                      title: "Inability to express deeper emotions",
                      icon: "bi-heart-pulse"
                    },
                    {
                      title: "Pressure to act mature beyond their age",
                      icon: "bi-heart-pulse"
                    }
                  ].map((cause, index) => (
                    <Col md={4} key={index}>
                      <div className="text-center p-3">
                        <div className="icon-wrapper bg-success-subtle text-success rounded-circle p-3 mb-3 mx-auto" style={{width: '56px', height: '56px'}}>
                          <i className={`bi ${cause.icon} fs-4`}></i>
                        </div>
                        <p className="mb-0 fw-medium">{cause.title}</p>
                      </div>
                    </Col>
                  ))}
                </Row>
        ...
        <section className="py-5 bg-light">
          <Container>
            <Row className="g-5">
              <Col lg={12} className="animate-on-scroll fade-in-up text-center mb-4">
                <div className="section-header mb-4 justify-content-center">
                  <div className="icon-wrapper bg-success-subtle text-success rounded-circle p-3 me-3 mx-auto">
                    <i className="bi bi-hearts fs-4"></i>
                  </div>
                </div>
                <h3 className="fw-bold mb-3">How EmotionEase Can Help</h3>
        ...
        <Container>
          <div className="animate-on-scroll fade-in-up text-center mb-5">
            ...
            <p className="text-muted">
              Here are some of the most common questions people ask about parent coaching and child development.
            </p>
          </div>
            ...
            <Col lg={10}>
              <Accordion defaultActiveKey="0" flush>
                ...
                <Accordion.Item eventKey="2" className="mb-3 shadow-sm rounded-3 border-0 overflow-hidden">
                  <Accordion.Header>How long does each parent coaching session with EmotionEase last?</Accordion.Header>
                  <Accordion.Body>
      ...
      <section className="py-5 bg-success text-light text-center">
        <Container>
          <h2 className="display-5 fw-bold mb-4">Ready to Transform Your Parenting Journey?</h2>
          <p className="lead mb-5 mx-auto" style={{ maxWidth: '600px' }}>
            Let EmotionEase guide you toward building a stronger, more confident family.
          </p>
          <Link 
            href="/contact"
